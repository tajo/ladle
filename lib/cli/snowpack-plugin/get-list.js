...
const debugSilly = require("debug")("ladle:silly");
...
const getStories = (stories, storiesParams) => {
  ...
  debugSilly(`storiesParams: ${JSON.stringify(storiesParams, null, "  ")}`);
...
const getList = async (entries) => {
    ...
    traverse(ast, {
      ...
      ExportDefaultDeclaration(astPath) {
        ...
        try {
          ...
          console.warn(`${entry}: Can't parse the default export.`);
        }
      },
  ...
  debugSilly(`Get list generated code: ${output}`);
